...
t[#t+1] = Def.ActorFrame {
	LoadActor("boo") .. {		
		OnCommand=cmd(sleep,0.7;queuecommand,"Play");
...
LoadActor(THEME:GetPathB("","_door/scsh_back03_gray"))..{
...
Def.Quad{
	InitCommand=cmd(halign,1;x,SCREEN_CENTER_X+80;CenterY;FullScreen;diffuse,color("White");diffusealpha,0);
	OnCommand=cmd(faderight,0.2;sleep,0.3;linear,0.1;diffusealpha,0.75;linear,0.3;addx,-(SCREEN_CENTER_X-150);diffusealpha,0;);
};

Def.Quad{
	InitCommand=cmd(halign,0;x,SCREEN_CENTER_X-80;CenterY;FullScreen;diffuse,color("White");diffusealpha,0);
	OnCommand=cmd(fadeleft,0.2;sleep,0.3;linear,0.1;diffusealpha,0.75;linear,0.3;addx,(SCREEN_CENTER_X+150);diffusealpha,0;);
};

		
--Animated grid
LoadActor(THEME:GetPathB("","_door/scsh_hamnicam_gray"))..{
...
t[#t+1] = Def.ActorFrame {
	--Left
	LoadActor(THEME:GetPathB("","_door/scene_choice_failed"))..{

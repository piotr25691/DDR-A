...
local function DrawDiffListItem(diff)
  local DifficultyListItem = Def.ActorFrame{
    ...
    Def.Quad{
      Name="Background";
      InitCommand=function(s) s:setsize(246,25):diffuse(Alpha(Color.White,0.8)):draworder(0) end,
    };
    Def.BitmapText{
      Font="_dispatrox 32px",
      Name="DiffLabel";
      InitCommand=function(self)
        self:halign(pn=='pnNumber_P2' and 1 or 0):draworder(99):diffuse(Color.Black):zoomx(0.5):zoomy(0.6):maxwidth(150)
        self:x(-119)
    ...
    Def.ActorFrame{
      ...
      Def.BitmapText{
        Font="_geo 95 20px",
        Name="Meter";
        InitCommand=function(s) s:draworder(99):strokecolor(Color.Black):y(-10):zoom(1.20) end,
        SetCommand=function(self)
          self:settext("")
          local st=GAMESTATE:GetCurrentStyle():GetStepsType()
          local song=GAMESTATE:GetCurrentSong()
    ...
    Def.BitmapText{
      Font="_geo 957 Bold",
      Name="Score";
      InitCommand=function(s) s:draworder(5):diffuse(Color.Black):xy(74,-1):zoom(1.1):halign(1):maxwidth(80) end,
      SetCommand=function(self)
        self:settext("")
    ...
    Def.ActorFrame{
      ...
      Def.Quad{
        Name="Grade";
      InitCommand=function(s) s:draworder(5):visible(false):zoom(0.9):x(4) end,
      SetCommand=function(self)
        local st=GAMESTATE:GetCurrentStyle():GetStepsType();
        local song=GAMESTATE:GetCurrentSong();
        if song then
  ...
  CurrentSongChangedMessageCommand=function(s) s:finishtweening():queuecommand("Set") end,
    ...
    Def.ActorFrame{
        Def.ActorFrame{
            ...
            Def.Sprite{
                Texture="scms_diff_window_tab",
                InitCommand=function(s) s:rotationy(pn==PLAYER_1 and 0 or 180):xy(8,-31) end,
                OnCommand=function(s) s:diffusealpha(0):sleep(0.4):diffusealpha(1) end,
            };
            Def.Sprite{
                Texture=lang.."_semufr_difficulty_change",
                InitCommand=function(s) s:xy(pn==PLAYER_1 and 7 or 20,-45) end,
    ...
    Def.ActorFrame{
      Def.Sprite{
           Texture="dif_windo_cursor_line",
        InitCommand=function(s) s:zoom(1):diffuseshift():effectcolor1(color("1,1,1,1")):effectcolor2(color("1,1,1,0.5")):effectperiod(0.8):visible(false) end,
	...
	Def.ActorFrame{
        Def.ActorFrame{
            InitCommand=function(s) s:zoom(1):visible(false) end,
        ...
        SetCommand=function(s)
          ...
          if song then
            ...
            if steps then
              local diff = steps:GetDifficulty();
              local st=GAMESTATE:GetCurrentStyle():GetStepsType();
			   s:y((Difficulty:Reverse()[diff] * yspacing)-114)
            end;
          else
            s:visible(false)
          end;
            ...
            Def.Sprite{
                Texture="dif_windo_cross_point",
				InitCommand=function(s) s:x(SCREEN_LEFT-130):y(SCREEN_TOP+18) end,
            };
			Def.Sprite{
                Texture="dif_windo_cross_point",
				InitCommand=function(s) s:x(SCREEN_LEFT-130):y(SCREEN_TOP+48) end,
            };
			Def.Sprite{
                Texture="dif_windo_cross_point",
				InitCommand=function(s) s:x(SCREEN_LEFT+125):y(SCREEN_TOP+48) end,
            };
			Def.Sprite{
                Texture="dif_windo_cross_point",
				InitCommand=function(s) s:x(SCREEN_LEFT+125):y(SCREEN_TOP+18) end,
            };
        }
    };

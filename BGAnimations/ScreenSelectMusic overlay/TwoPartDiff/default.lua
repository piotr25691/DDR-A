	...
	for i,steps in ipairs(songSteps) do
		...
		f[i] = Def.ActorFrame{
			...
			Def.ActorFrame{
				...
				Def.Sprite{
					Texture="scms_difficulty_card_base";
					InitCommand=cmd(xy,20,3;);
				};
				Def.Sprite{
					Texture="level_base_"..ToEnumShortString(diff);
					InitCommand=cmd(xy,-10,-38)
				};
				Def.Sprite{
					Texture="scms_difficulty_tab_clearlump";
					InitCommand=cmd(xy,68,-44;);
				};
			};
			Def.ActorFrame{
				StartSelectingStepsMessageCommand=function(s) s:diffusealpha(0):sleep(0.5):linear(0.1):diffusealpha(1) end,
				...
				Def.Sprite{
					Texture="back_shape_"..ToEnumShortString(diff);
					InitCommand=cmd(xy,-44,34);
				};
				Def.Sprite{
					Texture="scms_difficulty_tab_level";
					InitCommand=cmd(xy,-55,40);
				};
			};
			Def.Sprite{
				StartSelectingStepsMessageCommand=function(s) s:diffusealpha(0):sleep(0.5):linear(0.1):diffusealpha(1) end,
			...
			Def.Sprite{
				StartSelectingStepsMessageCommand=function(s) s:diffusealpha(0):sleep(0.5):linear(0.1):diffusealpha(1) end,
				Texture="hex_bk";
				InitCommand=cmd(zoom,.60;xy,-82,8);
			};
			Def.Sprite{
				StartSelectingStepsMessageCommand=function(s) s:diffusealpha(0):sleep(0.5):linear(0.1):diffusealpha(1) end,
			...
			Def.ActorFrame{
				...
				Def.Sprite{
					Texture="difficulty_hex_ok_effect.png",
                ...
                Def.Sprite{
					Texture="difficulty_pleasewait.png",
				...
				Def.Sprite{
					Texture="difficulty_pleasewait_dot.png",
			...
			LoadFont("difficulty numbers")..{
				StartSelectingStepsMessageCommand=function(s) s:diffusealpha(0):sleep(0.5):linear(0.1):diffusealpha(1) end,
				Text=steps:GetMeter();
				InitCommand=cmd(xy,60,-21);
			};
			Def.ActorFrame{
				InitCommand=function(s) s:xy(60,-56) end,
				StartSelectingStepsMessageCommand=function(s) s:diffusealpha(0):sleep(0.5):linear(0.1):diffusealpha(1) end,
				Def.Sprite{
					Texture=THEME:GetPathG("","_shared/00di_folder_lump_hole.png"),
